...
import InviteCollaborators from "@/components/trips/InviteCollaborators";
...
const TripDetailsPage = () => {
    ...
    const ScrollSection = ({ children, delay = 0 }) => (
        <motion.div
            ...
            viewport={{ amount: 0.2 }}   // 👈 repeat animation every scroll
    ...
    return (
        <section className="py-8 px-20 flex gap-4 bg-indigo-300">
            {/* ================= LEFT ================= */}
            <div className="w-2/3">
                <ScrollSection>
                    <Card className="w-full min-h-[80vh] bg-blue-200 shadow-xl border-none rounded-2xl">
                        <CardHeader className="space-y-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <CardTitle className="text-3xl font-bold text-blue-900 animate-bounce">
                                    {data.title}
                                </CardTitle>
                            </div>
                        ...
                        <CardContent className="space-y-6 mt-6">
                            ...
                            <ScrollSection delay={0.1}>
                                {/* ================= BUDGET PROGRESS ================= */}
                                <div className="bg-white p-4 rounded-xl shadow space-y-2 animate-caret-blink">
                            ...
                            <ScrollSection delay={0.2}>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    {/* Total Budget */}
                                    <div className="bg-linear-to-br from-green-50 to-green-100 p-4 rounded-xl shadow flex gap-3">
                                    ...
                                    {/* Total Spent */}
                                    <div className="bg-linear-to-br from-red-50 to-red-100 p-4 rounded-xl shadow flex gap-3">
                                    ...
                                    {/* Remaining */}
                                    <div className={`p-4 rounded-xl shadow flex gap-3 ${overspent
                                        ...
                                        <div>
                                            ...
                                            <p className={`text-xl font-bold ${overspent ? "text-red-700" : "text-green-700"
                                                }`}>
                                                Rs.{" "}
                                                <CountUp
                                                    end={remaining}
                            ...
                            <ScrollSection delay={0.4}>
                                ...
                                <div className="bg-white p-4 rounded-xl shadow">
                                    <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
                                        <Users size={18} className="text-green-600" /> Collaborators
                                    </h3>
                                    ...
                                    {data.collaborators && data.collaborators.length > 0 ? (
                                        <div className="flex flex-col gap-2">
                                            {data.collaborators.map((collab, i) => (
                                                <div
                                                    key={i}
                                                    className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg border hover:shadow transition"
                                                >
                                                    ...
                                                    <div className="flex flex-col">
                                                        <p className="font-medium text-gray-800">{collab.name || "No Name"}</p>
                                        ...
                                        <div className="flex items-center gap-2 text-gray-500 text-sm p-4 border rounded-lg bg-gray-50">
                                            <Users size={20} /> No collaborators yet. Invite someone using the form above!
                                        </div>
                                    )}
                                </div>
                            </ScrollSection>
