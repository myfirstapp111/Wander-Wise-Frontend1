...
const TripsNavigation = ({ trip }) => {
  return (
    <Card className="bg-blue-200 shadow-lg rounded-2xl border border-blue-200">
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        <a href={`/itineraries/${trip._id}`}>
          <Button
            variant="outline"
            className="w-full flex items-center justify-start gap-2 hover:bg-blue-200 transition"
          >
